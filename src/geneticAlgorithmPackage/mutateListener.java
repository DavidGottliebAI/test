 ...
 * 
 *         Purpose: <br> Chance to mutate any or all genes in a chromosome given a specific percentage
 *         Restriction: <br> Needs a number as input
 *         For example: <br> button.addActionListener(new mutateListener(editableViewer))
 *
 */
public class mutateListener implements ActionListener {
	...
	/**
	 * ensures: Depending on the number - num - placed in the JTextField and number - N - of genes in the chromosome, there will be a num/N
	 * percent chance for each button to mutate
	 */
	@Override
