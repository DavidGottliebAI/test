...
public class ScatterPlot extends Application {
	private ArrayList<Chromosome> fitnesses = new ArrayList<Chromosome>();
	...
	public void start(Stage stage) {
		...
		int count = 0;
		for (Chromosome chromosome : fitnesses) {
			series.getData().add(new XYChart.Data(chromosome.getFitness(), count));
			count++;
		}
...
//      series.getData().add(new XYChart.Data(6.5, 7));  
	...
	public void addEntry(ArrayList<Chromosome> chromosomeList) {
		fitnesses = chromosomeList;
	}
}