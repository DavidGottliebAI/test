 ...
 * 
 *         Purpose: Visualize editable viewer, population, evolutionary graph, and best chromosome
 *         Restriction: <br> Can only visualize, has no effect on what is drawn
 *         For example: <br> ViewerMain viewerMain = new ViewerMain()
 *
 */
